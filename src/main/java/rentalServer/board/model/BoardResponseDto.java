...
public class BoardResponseDto {
	...
	public BoardResponseDto(String user_id, int board_num, String title, String content, String type, Timestamp record,
			Timestamp mod_time) {
		super();
	...
	public BoardResponseDto(String user_id, int board_num, String title, String content, String type) {
		super();
		this.user_id = user_id;
		this.board_num = board_num;
		this.title = title;
